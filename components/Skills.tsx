...
function Skills({ }: Props) {
    return (
        <motion.div
            ...
            <h3 className='absolute top-36 text-decoration-line: underline uppercase tracking-[3px] text-gray-500 text-lg'>Hover over a Skill for currency Profieciency</h3>
