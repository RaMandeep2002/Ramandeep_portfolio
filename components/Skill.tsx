    ...
    return (
        <div className='group relative flex cursor-pointer'>
            <motion.img
                ...
                className='rounded-full border border-gray-500 object-cover w-20 h-20 md:h-24 md:w-24 xl:w-24 xl:h-24 filter group-hover:grayscale transition duration-300 ease-in-out'
            />
